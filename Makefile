...
F90_FLAGS = -Wall -Wextra  -traceback  -cudalib=cublas -lblas -mp=gpu -gpu=nvlamath -cudalib=nvlamath  -llapack
...
qt.x : main.f90  static.o  mkl_dfti.o linalg.o matrix_c.o graph_partition.o wannierHam3d.o deviceHam_mod.o cuda_rgf_mod.o output_mod.o negf_mod.o
